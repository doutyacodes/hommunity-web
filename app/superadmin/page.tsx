    ...
    <div className="p-6 md:p-10 max-w-7xl mx-auto w-full animate-in fade-in duration-500">
      <div className="mb-10">
        ...
        <p className="text-slate-500 max-w-2xl">
          Complete network overview of the Hommunity Ledger. Monitor system-wide
          health, active administrative nodes, and security rule enforcement.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
        {[
          {
            label: "Active Nodes",
            value: allBuildings.length.toString(),
            icon: Server,
            color: "text-blue-600",
          ...
          {
            label: "System Admins",
            value: localAdmins.length.toString(),
            icon: Users,
          ...
          },
          {
            ...
            value: rulesCount.count.toString(),
            icon: Shield,
          ...
          >
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 border ${stat.bg} ${stat.color}`}
            >
              <stat.icon size={22} />
            </div>
            ...
            <h3 className="text-3xl font-black text-slate-900 font-headline">
              {stat.value}
            </h3>
          </div>
        ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-slate-200 shadow-sm rounded-3xl p-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link
              ...
              className="text-xs font-bold text-blue-600 hover:underline underline-offset-4 flex items-center gap-1"
            >
          ...
          {allBuildings.length > 0 ? (
            <div className="space-y-4">
              {allBuildings.slice(0, 3).map((b: any) => (
                <div
                  key={b.id}
        ...
        <div className="bg-white border border-slate-200 shadow-sm rounded-3xl p-8">
          <h3 className="text-lg font-bold text-slate-900 font-headline mb-6">
            Quick Actions
          </h3>
          <div className="space-y-3">
            <Link
              href="/buildings/new"
              className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl hover:bg-slate-50 hover:shadow-sm transition-all group"
            >
